...
SETTINGS_SCHEMA: tuple[SettingSpec, ...] = (
    ...
    SettingSpec("RESEARCH_MODEL", "Research model", "choice", "gemini-3-flash-preview", "Research", "Specific AI model. Selecting this sets the provider and model field below automatically.", (
        "gpt-5.4",
        "gpt-5.4-mini",
        "gpt-5.4-nano",
    ...
    SettingSpec("OPENAI_MODEL", "OpenAI model", "str", "gpt-5.4-mini", "Research", "OpenAI model for hosted research."),
    ...
    SettingSpec("SEND", "Real email sending", "bool", False, "Run", "Off means dry-run. On sends through SMTP."),
