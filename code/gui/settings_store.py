"""Laedt, validiert und speichert Workbench-Einstellungen und Umgebungswerte."""
...
class SettingSpec:
    """Beschreibt einen einzelnen konfigurierbaren Einstellungswert."""
    key: str
    label: str
    kind: SettingKind
    default: Any
...
def schema_by_key() -> dict[str, SettingSpec]:
    """Kapselt den Arbeitsschritt schema_by_key."""
...
def _unquote_env_value(value: str) -> str:
    """Kapselt den Arbeitsschritt _unquote_env_value."""
