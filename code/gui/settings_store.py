...
SETTINGS_SCHEMA: tuple[SettingSpec, ...] = (
    ...
    SettingSpec("EXTERNAL_VALIDATION_SERVICE", "External validation", "choice", "auto", "Mail", "Auto uses ZeroBounce or NeverBounce when exactly one matching API key is present; choose a provider explicitly to force one service.", ("auto", "none", "zerobounce", "neverbounce")),
    ...
    SettingSpec("SPAM_SAFE_MODE", "Spam-safe mode", "bool", False, "Mail", "Uses spam-safe mail templates and sends without file attachments."),
    ...
    SettingSpec("SIGNATURE_HTML", "Signature HTML file", "str", r"C:\Users\Carina\OneDrive\Work\Allgemein\Logo\signature.html", "Mail", "HTML signature file appended to every sent mail.", slider=False),
...
ENV_SCHEMA: tuple[SettingSpec, ...] = (
    ...
    SettingSpec("ZEROBOUNCE_API_KEY", "ZeroBounce API key", "str", "", "Validation Secrets", "API key used when External validation is auto or zerobounce."),
    SettingSpec("NEVERBOUNCE_API_KEY", "NeverBounce API key", "str", "", "Validation Secrets", "API key used when External validation is auto or neverbounce."),
